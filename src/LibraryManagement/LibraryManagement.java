...
public class LibraryManagement 
{
	...
	public static void LibraryManagement() throws IOException
	{
		...
		{
			System.out.println("_WELCOME TO LIBRARY MANAGEMENT__");
			System.out.println("\n");
			...
			if(optionSelectedByUser==LibraryOptions.Quite)
			{
				File file=new File("C:\\Users\\Jai\\eclipse-workspace\\Library_management\\src\\LibraryManagement\\library.txt");
		...
		for(Library library:al)
		{
			...
			System.out.println(library.BookID);
			System.out.println(library.AuthorName);
			System.out.println(library.Price);
			System.out.println(library.BookCategory);
		}
	}
